...
namespace gtsam_soslam {
    ...
    std::vector<Detection> HandMadeDetector::detect(SoSlamState &state) {
        ...
        for (pugi::xml_node object = root.child("object"); object; object = object.next_sibling("object")) {
            ...
            bounds << bndbox.child("xmin").text().as_int(), bndbox.child("ymin").text().as_int(), bndbox.child(
                    "xmax").text().as_int(), bndbox.child("ymax").text().as_int();
    ...
    HandMadeAssociator::associate(SoSlamState &state) {
