...
int main(int argc, char *argv[]) {
    ...
    if (use_dummy_data) {
        ...
        gtsam::Pose3 pose(gtsam::Rot3::Quaternion(-0.4095, 0.6529, -0.5483, 0.3248), //input_scene1
                          gtsam::Point3(-0.1546, -1.4445, 1.4773));
//        gtsam::Pose3 pose(gtsam::Rot3::Quaternion(-0.4832, 0.5869, 0.4973, -0.4181), //input_scene2
//                          gtsam::Point3(0.2475, -0.2891, 0.9502));
//        gtsam::Pose3 pose(gtsam::Rot3::Quaternion(-0.4599, 0.8685, 0.1430, -0.1171), //input_scene3
//                          gtsam::Point3(1.5036, 0.9272, 1.4526));
