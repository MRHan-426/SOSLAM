...
template<>
struct gtsam::traits<gtsam_soslam::ConstrainedDualQuadric>
        : public gtsam::internal::Manifold<gtsam_soslam::ConstrainedDualQuadric> {
};

template<>
struct gtsam::traits<const gtsam_soslam::ConstrainedDualQuadric>
        : public gtsam::internal::Manifold<gtsam_soslam::ConstrainedDualQuadric> {
};
/** \endcond */
